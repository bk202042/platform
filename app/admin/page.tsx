    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <p className="text-3xl font-bold">{propertyError ? '—' : propertyCount || 0}</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-2">
            <p className="text-sm text-gray-500">Quick access to common tasks</p>
            <div className="flex flex-col space-y-2">
              <a href="/admin/properties" className="text-sm text-blue-600 hover:underline">
                Manage Properties
              </a>
